...
var <?php echo $objectrow['name'];?> = nv.models.lineWithFocusChart().margin({right: 35});/*fixes last pixel from getting clipped in bootstrap*/
...
<?php echo $objectrow['name'];?>.x2Axis
